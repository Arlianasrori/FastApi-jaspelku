...
@adminRouter.post("/tujuan_user_category",response_model=ResponseModel[ResponseTujuanUserCategory],tags=["ADMIN/TUJUAN_USER_CATEGORY"])
...
@adminRouter.put("/tujuan_user_category/{id}",response_model=ResponseModel[ResponseTujuanUserCategory],tags=["ADMIN/TUJUAN_USER_CATEGORY"])
...
@adminRouter.delete("/tujuan_user_category/{id}",response_model=ResponseModel[ResponseTujuanUserCategory],tags=["ADMIN/TUJUAN_USER_CATEGORY"])
...
@adminRouter.get("/tujuan_user_category",response_model=ResponseModel[list[ResponseTujuanUserCategory]],tags=["ADMIN/TUJUAN_USER_CATEGORY"])
...
# pelayanan servant
@adminRouter.post("/pelayanan_servant_category",response_model=ResponseModel[ResponsePelayananServantCategory],tags=["ADMIN/SERVANT/PELAYANAN_CATEGORY"])
...
@adminRouter.put("/pelayanan_servant_category/{id}",response_model=ResponseModel[ResponsePelayananServantCategory],tags=["ADMIN/SERVANT/PELAYANAN_CATEGORY"])
...
@adminRouter.delete("/pelayanan_servant_category/{id}",response_model=ResponseModel[ResponsePelayananServantCategory],tags=["ADMIN/SERVANT/PELAYANAN_CATEGORY"])
...
@adminRouter.get("/pelayanan_servant_category",response_model=ResponseModel[list[ResponsePelayananServantCategory]],tags=["ADMIN/SERVANT/PELAYANAN_CATEGORY"])
...
# servant
@adminRouter.get("/servant",response_model=ResponseModel[list[ServantBase]],tags=["ADMIN/SERVANT/SERVANT_MANAGEMENT"])
async def getAllServant(session : sessionDepedency) :
    return await servantManagementService.getAllServants(session)

@adminRouter.get("/servant/search",response_model=ResponseModel[SearchServantResponse],tags=["ADMIN/SERVANT/SERVANT_MANAGEMENT"])
...
@adminRouter.get("/servant/{id}",response_model=ResponseModel[MoreServantBase],tags=["ADMIN/SERVANT/SERVANT/SERVANT_MANAGEMENT"])
async def getServantById(id : str,session : sessionDepedency) :
    return await servantManagementService.getServantById(id,session)

@adminRouter.post("/servant",response_model=ResponseModel[ServantBase],tags=["ADMIN/SERVANT/SERVANT_MANAGEMENT"])
...
@adminRouter.put("/servant/{id}",response_model=ResponseModel[ServantBase],tags=["ADMIN/SERVANT/SERVANT_MANAGEMENT"])
...
@adminRouter.delete("/servant/{id}",response_model=ResponseModel[ServantBase],tags=["ADMIN/SERVANT/SERVANT_MANAGEMENT"])
...
# vendee
@adminRouter.get("/vendee",response_model=ResponseModel[list[VendeeBase]],tags=["ADMIN/VENDEE/VENDEE_MANAGEMENT"])
async def getAllVendee(session : sessionDepedency) :
    return await vendeeManagementService.getAllvendees(session)

@adminRouter.get("/vendee/search",response_model=ResponseModel[SearchVendeeResponse],tags=["ADMIN/VENDEE/VENDEE_MANAGEMENT"])
...
@adminRouter.get("/vendee/{id}",response_model=ResponseModel[MoreVendee],tags=["ADMIN/VENDEE/VENDEE_MANAGEMENT"])
async def getVendeeById(id : str,session : sessionDepedency) :
    return await vendeeManagementService.getvendeeById(id,session)

@adminRouter.post("/vendee",response_model=ResponseModel[VendeeBase],tags=["ADMIN/VENDEE/VENDEE_MANAGEMENT"])
...
@adminRouter.put("/vendee/{id}",response_model=ResponseModel[VendeeBase],tags=["ADMIN/VENDEE/VENDEE_MANAGEMENT"])
...
@adminRouter.delete("/vendee/{id}",response_model=ResponseModel[VendeeBase],tags=["ADMIN/VENDEE/VENDEE_MANAGEMENT"])
...
@adminRouter.get("/tujuan_servant_category",response_model=ResponseModel[list[TujuanServantCategoryBase]],tags=["ADMIN/SERVANT/TUJUAN_SERVANT_CATEGORY"])
...
@adminRouter.get("/tujuan_servant_category/{id}",response_model=ResponseModel[TujuanServantCategoryBase],tags=["ADMIN/SERVANT/TUJUAN_SERVANT_CATEGORY"])
...
@adminRouter.post("/tujuan_servant_category",response_model=ResponseModel[TujuanServantCategoryBase],tags=["ADMIN/SERVANT/TUJUAN_SERVANT_CATEGORY"])
...
@adminRouter.put("/tujuan_servant_category/{id}",response_model=ResponseModel[TujuanServantCategoryBase],tags=["ADMIN/SERVANT/TUJUAN_SERVANT_CATEGORY"])
...
@adminRouter.delete("/tujuan_servant_category/{id}",response_model=ResponseModel[TujuanServantCategoryBase],tags=["ADMIN/SERVANT/TUJUAN_SERVANT_CATEGORY"])
...
@adminRouter.get("/tujuan_vendee_category",response_model=ResponseModel[list[TujuanVendeeCategoryBase]],tags=["ADMIN/VENDEE/TUJUAN_VENDEE_CATEGORY"])
...
@adminRouter.get("/tujuan_vendee_category/{id}",response_model=ResponseModel[TujuanVendeeCategoryBase],tags=["ADMIN/VENDEE/TUJUAN_VENDEE_CATEGORY"])
...
@adminRouter.post("/tujuan_vendee_category",response_model=ResponseModel[TujuanVendeeCategoryBase],tags=["ADMIN/VENDEE/TUJUAN_VENDEE_CATEGORY"])
...
@adminRouter.put("/tujuan_vendee_category/{id}",response_model=ResponseModel[TujuanVendeeCategoryBase],tags=["ADMIN/VENDEE/TUJUAN_VENDEE_CATEGORY"])
...
@adminRouter.delete("/tujuan_vendee_category/{id}",response_model=ResponseModel[TujuanVendeeCategoryBase],tags=["ADMIN/VENDEE/TUJUAN_VENDEE_CATEGORY"])
...
# pesanan 
@adminRouter.get("/pesanan/search",response_model=ResponseModel[SearchPesananResponse],tags=["ADMIN/PESANAN"])
...
@adminRouter.get("/pesanan/analitic/search",response_model=ResponseModel[StatisticPesanan],tags=["ADMIN/PESANAN"])
...
@adminRouter.get("/pesanan/statistic/today",response_model=ResponseModel[StatisticPesanan],tags=["ADMIN/PESANAN"])
...
@adminRouter.get("/pesanan/{id}",response_model=ResponseModel[PesananWithVendeeServant],tags=["ADMIN/PESANAN"])
...
@adminRouter.get("/pesanan/overview/{year}",response_model=ResponseModel[ResponseOverviewPesanan],tags=["ADMIN/PESANAN"])
...
# order
@adminRouter.get("/order/search",response_model=ResponseModel[SearchOrderResponse],tags=["ADMIN/ORDER"])
...
@adminRouter.get("/order/statistic/search",response_model=ResponseModel[StatisticOrder],tags=["ADMIN/ORDER"])
...
@adminRouter.get("/order/{id}",response_model=ResponseModel[OrdernWithVendeeServant],tags=["ADMIN/ORDER"])
...
@adminRouter.get("/order/statistic/today",response_model=ResponseModel[StatisticOrder],tags=["ADMIN/ORDER"])
...
@adminRouter.get("/order/overview/{year}",response_model=ResponseModel[ResponseOverviewOrder],tags=["ADMIN/ORDER"])
